...
public class ExcelUpdaterTest extends AConceptProjectTestCase {
	...
	private static final String CONCEPT_CEF = de.dlr.sc.virsat.model.extension.cef.Activator.PLUGIN_ID;
	...
	public void setUp() throws CoreException {
		...
		conceptCEF = loadConceptFromPlugin(CONCEPT_CEF);
		
	    Equipment equipment = new Equipment(conceptCEF);
	    sei = equipment.getStructuralElementInstance();
		
		paramInput = new Parameter(conceptCEF);
		paramOutput = new Parameter(conceptCEF);
		
		modeA = new SystemMode(conceptCEF);
		modeB = new SystemMode(conceptCEF);
		
		modeA.setName("Mode A");
		modeB.setName("Mode B");
		
		modeValueA = new Value(conceptCEF);
		modeValueB = new Value(conceptCEF);
		...
		excelCalc = new ExcelCalculation(conceptCEF);
