 ...
 * 
 */	
public abstract class ACreateAddEquipmentTemperatureParametersCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		EquipmentTemperatureParameters conceptObject = new EquipmentTemperatureParameters(activeConcept);
