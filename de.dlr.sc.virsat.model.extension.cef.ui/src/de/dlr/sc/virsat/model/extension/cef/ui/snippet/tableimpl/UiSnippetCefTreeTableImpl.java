 ...
 *******************************************************************************/
package de.dlr.sc.virsat.model.extension.cef.ui.snippet.tableimpl;
...
import de.dlr.sc.virsat.model.extension.cef.ui.util.CefUiHelper;
...
public class UiSnippetCefTreeTableImpl extends UiSnippetGenericTreeTableImpl {
	...
	protected void createTableColumns(EditingDomain editingDomain) {
		...
		AProperty defaultValueProperty = acHelper.getProperty(PluginXml.Concept.Extensioncef1_6.ID, Parameter.class.getSimpleName(), Parameter.PROPERTY_DEFAULTVALUE); //Parameter.class.getSimpleName() = non fully qualified name, e.g. "Parameter"
		...
		AProperty valueProperty = acHelper.getProperty(PluginXml.Concept.Extensioncef1_6.ID, Value.class.getSimpleName(), Value.PROPERTY_VALUE);
