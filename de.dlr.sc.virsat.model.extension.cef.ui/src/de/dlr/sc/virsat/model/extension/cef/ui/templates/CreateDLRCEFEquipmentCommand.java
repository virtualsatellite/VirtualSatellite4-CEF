 ...
 *
 */
public class CreateDLRCEFEquipmentCommand {

	/**
	 * Private constructor.
	 */
	private CreateDLRCEFEquipmentCommand() {
	}
	...
	public static CompoundCommand create(EObject parent, Concept concept, VirSatTransactionalEditingDomain domain) {
		...
		cmd.append(DLRCEFStudyCommandHelper.createAddChildSEICommand(parent, equipment.getStructuralElementInstance(), domain));
