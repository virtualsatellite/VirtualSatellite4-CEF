...
public class ModeVectorEvaluatorTest extends ATestCase {
	...
	public void testWithConcept1() {
		...
		EquipmentMassParameters equipMassParams = new EquipmentMassParameters(concept);
		EquipmentParameters equipParams = new EquipmentParameters(concept);
		SystemMode idleMode = new SystemMode(concept);
	...
	public void testWithConcept2() {
		Equipment equipment = new Equipment(concept);
		EquipmentParameters equipParams = new EquipmentParameters(concept);
		EquipmentPowerParameters equipPowerParams = new EquipmentPowerParameters(concept);
		SystemMode idleMode = new SystemMode(concept);
	...
	public void testWithConceptNaN() {
		SystemMassParameters systemMassParams = new SystemMassParameters(concept);
