 ...
 * 
 */
@XmlType(name = ASystemOfSystems.FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME)
public class SystemOfSystems extends ASystemOfSystems {
	...
	/**
 	 ...
 	 */
	public SystemOfSystems(Concept concept) {
		super(concept);
	}	
	 ...
	 */
	public SystemOfSystems(StructuralElementInstance sei) {
		super(sei);
	}
}
