 ...
 * 
 */	
public abstract class AAInterface extends ABeanCategoryAssignment implements IBeanCategoryAssignment {
	...
	public AAInterface(Concept concept) {
		Category categoryFromActiveCategories = ActiveConceptHelper.getCategory(concept, "AInterface");
		CategoryAssignment categoryAssignement = new CategoryInstantiator().generateInstance(categoryFromActiveCategories, "AInterface");
		setTypeInstance(categoryAssignement);
	}
	
	public AAInterface(CategoryAssignment categoryAssignement) {
		setTypeInstance(categoryAssignement);
	}
