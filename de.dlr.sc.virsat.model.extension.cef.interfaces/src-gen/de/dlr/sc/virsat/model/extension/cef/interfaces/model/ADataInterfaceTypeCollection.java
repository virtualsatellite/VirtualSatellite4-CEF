 ...
 * 
 */	
public abstract class ADataInterfaceTypeCollection extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.cef.interfaces.DataInterfaceTypeCollection";
	 ...
	 */
	public ADataInterfaceTypeCollection() {
	}
	 ...
	 */
	public ADataInterfaceTypeCollection(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "DataInterfaceTypeCollection");
	 ...
	 */
	public ADataInterfaceTypeCollection(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
