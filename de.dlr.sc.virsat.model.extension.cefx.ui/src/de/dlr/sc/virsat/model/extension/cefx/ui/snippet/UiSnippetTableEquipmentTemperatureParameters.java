...
import de.dlr.sc.virsat.model.extension.cefx.ui.snippet.AUiSnippetTableEquipmentTemperatureParameters;
 ...
 * 
 */
public class UiSnippetTableEquipmentTemperatureParameters extends AUiSnippetTableEquipmentTemperatureParameters {
	@Override
	...
	protected IStructuredContentProvider getTableContentProvider() {
		return new VirSatCefTreeContentProvider(adapterFactory, EquipmentTemperatureParameters.FULL_QUALIFIED_CATEGORY_NAME);
	}
}
