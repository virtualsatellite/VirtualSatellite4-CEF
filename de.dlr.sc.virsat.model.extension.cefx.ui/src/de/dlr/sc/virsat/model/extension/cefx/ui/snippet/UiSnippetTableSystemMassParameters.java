...
import de.dlr.sc.virsat.model.extension.cefx.ui.snippet.AUiSnippetTableSystemMassParameters;
 ...
 * 
 */
public class UiSnippetTableSystemMassParameters extends  AUiSnippetTableSystemMassParameters {
	@Override
	...
	protected IStructuredContentProvider getTableContentProvider() {
		return new VirSatCefTreeContentProvider(adapterFactory, SystemMassParameters.FULL_QUALIFIED_CATEGORY_NAME);
	}
}
