 ...
 * 
 */
public class UiSnippetTableSystemPowerParameters extends  AUiSnippetTableSystemPowerParameters {
	...
	protected IStructuredContentProvider getTableContentProvider() {
		return new VirSatCefTreeContentProvider(adapterFactory, SystemPowerParameters.FULL_QUALIFIED_CATEGORY_NAME);
	}
