...
import de.dlr.sc.virsat.model.extension.cefx.ui.snippet.AUiSnippetTableSubSystemPowerParameters;
 ...
 * 
 */
public class UiSnippetTableSubSystemPowerParameters extends AUiSnippetTableSubSystemPowerParameters {
	@Override
	...
	protected IStructuredContentProvider getTableContentProvider() {
		return new VirSatCefTreeContentProvider(adapterFactory, SubSystemPowerParameters.FULL_QUALIFIED_CATEGORY_NAME);
	}
}