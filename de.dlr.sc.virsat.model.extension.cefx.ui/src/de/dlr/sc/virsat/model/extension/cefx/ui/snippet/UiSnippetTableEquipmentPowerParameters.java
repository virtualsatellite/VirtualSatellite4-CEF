...
import de.dlr.sc.virsat.model.extension.cefx.ui.snippet.AUiSnippetTableEquipmentPowerParameters;
 ...
 * 
 */
public class UiSnippetTableEquipmentPowerParameters extends AUiSnippetTableEquipmentPowerParameters {
	@Override
	...
	protected IStructuredContentProvider getTableContentProvider() {
		return new VirSatCefTreeContentProvider(adapterFactory, EquipmentPowerParameters.FULL_QUALIFIED_CATEGORY_NAME);
	}
}
