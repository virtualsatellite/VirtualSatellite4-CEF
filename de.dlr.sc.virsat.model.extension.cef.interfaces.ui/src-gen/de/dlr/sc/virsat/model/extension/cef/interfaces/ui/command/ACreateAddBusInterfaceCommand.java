...
import de.dlr.sc.virsat.model.extension.cef.interfaces.model.BusInterface;
 ...
 * 
 */	
public abstract class ACreateAddBusInterfaceCommand {
	public Command create(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		BusInterface conceptObject = new BusInterface(activeConcept);
