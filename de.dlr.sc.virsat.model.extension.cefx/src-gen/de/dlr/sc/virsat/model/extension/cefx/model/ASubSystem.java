 ...
 * 
 */	
public abstract class ASubSystem extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.cefx.SubSystem";
	 ...
	 */
	public ASubSystem(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "SubSystem");
	 ...
	 */
	public ASubSystem(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
