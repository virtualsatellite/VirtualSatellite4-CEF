 ...
 * 
 */	
public abstract class ASystemOfSystems extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.cefx.SystemOfSystems";
	 ...
	 */
	public ASystemOfSystems(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "SystemOfSystems");
	 ...
	 */
	public ASystemOfSystems(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
