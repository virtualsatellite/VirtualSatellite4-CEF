 ...
 * 
 */	
public abstract class ADocument extends ABeanCategoryAssignment implements IBeanCategoryAssignment {

	public static final String FULL_QUALIFIED_CATEGORY_NAME = "de.dlr.sc.virsat.model.extension.cefx.Document";
	...
	// * Attribute: name
	// *****************************************************************
	private BeanPropertyString name = new BeanPropertyString();
	
	private void safeAccessName() {
		if (name.getTypeInstance() == null) {
			name.setTypeInstance((ValuePropertyInstance) helper.getPropertyInstance("name"));
		}
	}
	
	public Command setName(EditingDomain ed, String value) {
		safeAccessName();
		return this.name.setValue(ed, value);
	}
