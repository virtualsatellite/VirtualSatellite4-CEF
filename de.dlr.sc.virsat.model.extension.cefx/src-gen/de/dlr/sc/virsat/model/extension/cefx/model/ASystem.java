 ...
 * 
 */	
public abstract class ASystem extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.cefx.System";
	 ...
	 */
	public ASystem(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "System");
	 ...
	 */
	public ASystem(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
