 ...
 * 
 */	
public abstract class AEquipment extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {

	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.cefx.Equipment";
	 ...
	 */
	public AEquipment(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "Equipment");
	 ...
	 */
	public AEquipment(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
